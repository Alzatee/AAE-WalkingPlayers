function hideMenu() {
    //HIDDEN MENU WP
    document.getElementById('menu-wp').style.display = 'none';
}

function showMenu() {
    //SHOW MENU WP
    document.getElementById('menu-wp').style.display = 'block';
}

function playAlzaNinjaMinigame() {
    // globalConfig.js
    // ============================================================================
    // ============================================================================
    ...
    function renderMenus() {
        ...
        switch (state.menus.active) {
            ...
            case MENU_SCORE:
                ...
                if (isNewHighScore()) {
                    highScoreLblNode.textContent = 'Nuevo record!';
                } else {
                    highScoreLblNode.textContent = `Puntuación más alta: ${formatNumber(getHighScore())}`;
                }
